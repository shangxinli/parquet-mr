...
/**
 * Zstandard compression codec for Parquet.  We do not use the default hadoop
 * one since that codec adds a blocking structure around the base zstd compression
